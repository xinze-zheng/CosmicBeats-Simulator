    ...
    base_str = """
{
    ...
    loc_id = 0
    file_path = []
    for dirpath,_,filenames in os.walk('/home/xinzez2/cdn/dataset/popular_video_113/patterns_10'):
        for f in filenames:
    ...
    end_str = """
            ...
            "isl_topology": "/home/xinzez2/cdn/CosmicBeats-Simulator/config_generators/orbit_trail/isl.json"
            }
        ],
        "simtime":
        {
